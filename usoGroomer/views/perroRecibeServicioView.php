...
?>
        <div id="modal" class="bg-gray-600 bg-opacity-50 flex items-center justify-center ">
            <div class="bg-white p-4 rounded shadow-lg w-1/2">
                ...
                <form id="crearNuevoServicio" class="space-y-4" method="POST" action="http://localhost/Groomer-Lidia-PHP/usoGroomer/home.php?controller=perroRecibeServicioUso&action=crearServicioRealizadoAPerro">
                    <div>
                    ...
                    <div class="flex justify-end">
                        <a href="http://localhost/Groomer-Lidia-PHP/usoGroomer/home.php?controller=perroRecibeServicioUso&action=mostrarServiciosPorPerros"><button type="button" class="bg-gray-500 text-white px-4 py-2 rounded mr-2">Cancelar</button></a>
