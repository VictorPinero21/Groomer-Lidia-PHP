...
class ServiciosView{
    ...
    public function showServices($listaServices){
        ...
        <div class="bg-white p-4 rounded shadow mb-4 overflow-x-auto">
            ...
            <a href="http://localhost/grommer/Groomer-Lidia-PHP/usoGroomer/index.php?controller=serviciosUso&action=showForm"><button>Crear Servicio</button></a>
                ...
                <tbody id="serviciosLista" class="bg-white divide-y divide-gray-200">
                    ...
                    if (is_array($listaServices)) {
                        foreach ($listaServices as $servicio) {
                            ...
                            echo "<td class='px-4 py-2 whitespace-nowrap'><a href='http://localhost/grommer/Groomer-Lidia-PHP/usoGroomer/index.php?controller=serviciosUso&action=showEditForm&id=". $servicio['Codigo'] ."&precio=". $servicio['Precio'] ."' ><button class='bg-red-500 text-white px-4 py-2 rounded'>Editar</button></a></td>";
                            // echo "</form>";
                            echo "</tr>";
                        }
                    }
...
<?php
    ...
    public function showEdit(){
        ...
        <div id="modal" class="fixed inset-0 bg-gray-800 bg-opacity-75 flex items-center justify-center">
            <div class="bg-white p-6 rounded shadow-lg w-1/3">
                ...
                <form id="editarServicioForm" class="space-y-4 text-left" method="POST" action="http://localhost/grommer/Groomer-Lidia-PHP/usoGroomer/index.php?controller=serviciosUso&action=editService">
                    <div>
                    ...
                    <div class="flex justify-end">
                        <a href='http://localhost/grommer/Groomer-Lidia-PHP/usoGroomer/index.php?controller=serviciosUso&action=showServicios'><button type="button" class="bg-gray-200 text-black px-4 py-2 rounded mr-2">Cancelar</button></a>
    ...
    public function crearServicio() {
        ...
        <div id="modal" class="fixed inset-0 bg-gray-800 bg-opacity-75 flex items-center justify-center">
            ...
            <form id="crearServicioForm" class="space-y-4 text-left" method="POST" action="http://localhost/grommer/Groomer-Lidia-PHP/usoGroomer/index.php?controller=serviciosUso&action=createService">
                <div>
