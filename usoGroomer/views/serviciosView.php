            ...
            <div class="bg-white p-6 rounded shadow-lg w-1/3">
                ...
                <form id="editarServicioForm" class="space-y-4 text-left" method="POST" action="http://localhost/Groomer-Lidia-PHP/usoGroomer/views/home.php?controller=serviciosUso&action=editService">
                    ...
                    <div class="flex justify-end">
                        <a href='http://localhost/Groomer-Lidia-PHP/usoGroomer/views/home.php?controller=serviciosUso&action=showServicios'><button type="button" class="bg-gray-200 text-black px-4 py-2 rounded mr-2">Cancelar</button></a>
