...
?>
    ...
    ?>
        ...
        <div class="bg-white p-8 rounded-lg shadow-lg max-w-3xl mx-auto">
            ...
            <form action="./home.php?controller=empleadosUso&action=showEmpleados" method="post" class="text-center mb-6">
                        ...
                        foreach ($empleadosLista as $empleado) {
                            echo "<tr>
                                    ...
                                    <td class='px-4 py-2 text-left whitespace-nowrap'>
                                        <a href='http://localhost/Groomer-Lidia-PHP/usoGroomer/home.php?controller=empleadosUso&action=editEmpleado&dni=" . (isset($empleado['DNI']) ? $empleado['DNI'] : '') . "' class='text-blue-600 hover:text-blue-800'>Editar</a>
