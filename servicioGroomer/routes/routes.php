...
$routes = [
    ...
    "GET" => [
        ...
        "/api/perroservicios/id/{id}" => [$perroServicioController, "getUnPerroConServicio"],
        "/api/perroservicios/dni/{dniempleado}" => [$perroServicioController, "getServiciosPorEmpleado"],
